...
const CourseDetails = () => {
  ...
  useEffect(() => {
    const fetchCourseDetails = async () => {
      try {
        ...
        const response = await fetch(`https://timebankbackend.vercel.app/api/courses/${id}`, {
          method: "GET",
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const transactionResponse = await fetch(`https://timebankbackend.vercel.app/api/transactions/spend`, {
        method: "POST",
        headers: { 
      ...
      const purchaseResponse = await fetch(`https://timebankbackend.vercel.app/api/courses/${id}/purchase`, {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` },
      });
